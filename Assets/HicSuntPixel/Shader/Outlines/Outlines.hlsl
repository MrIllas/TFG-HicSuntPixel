                    ...
                    out float Out, out float OutDepth, out float OutNormals)
{
    ...
    OutDepth = 1 - step(DepthEdgeStrength * depthEdge, 0); //DepthEdgeStrength * depthEdge;
    OutNormals = 1 - step(NormalEdgeStrength * normalEdge, 0); //NormalEdgeStrength * normalEdge;
